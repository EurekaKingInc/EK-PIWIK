<?php return array (
  ...
  array (
    'General' => 
    array (
      'AllWebsitesDashboard' => 'সকল ওয়েবসাইটের ড্যাশবোর্ড',
      'API' => 'এপিআই',
      'Cancel' => 'বাতিল করুন',
      'Close' => 'বন্ধ করুন',
      'Daily' => 'দৈনিক',
    ...
    array (
      ...
      'Activated' => 'সক্রিয় হয়েছে',
      'Active' => 'সক্রিয়',
      'Deactivate' => 'নিষ্ক্রিয়করণ',
      'Inactive' => 'নিষ্ক্রিয়',
    ...
    'Intl' => 
    array (
      'Continent_afr' => 'আফ্রিকা',
      'Continent_amc' => 'মধ্য আমেরিকা',
      'Continent_amn' => 'উত্তর আমেরিকা',
      'Continent_ams' => 'দক্ষিণ আমেরিকা',
      'Continent_ant' => 'অ্যান্টার্কটিকা',
      ...
      'Country_AR' => 'আর্জেন্টিনা',
      'Country_AS' => 'আমেরিকান সামোয়া',
      'Country_AT' => 'অস্ট্রিয়া',
      'Country_AU' => 'অস্ট্রেলিয়া',
      'Country_AW' => 'আরুবা',
      'Country_AX' => 'আলান্ড দ্বীপপুঞ্জ',
      ...
      'Country_DK' => 'ডেনমার্ক',
      'Country_DM' => 'ডোমিনিকা',
      'Country_DO' => 'ডোমেনিকান প্রজাতন্ত্র',
      'Country_DZ' => 'আলজেরিয়া',
      'Country_EC' => 'ইকুয়েডর',
      'Country_EE' => 'এস্তোনিয়া',
      'Country_EG' => 'মিশর',
      'Country_EH' => 'পশ্চিম সাহারা',
      'Country_ER' => 'ইরিত্রিয়া',
      'Country_ES' => 'স্পেন',
      'Country_ET' => 'ইফিওপিয়া',
      'Country_FI' => 'ফিনল্যান্ড',
      'Country_FJ' => 'ফিজি',
      'Country_FK' => 'ফকল্যান্ড দ্বীপপুঞ্জ',
      'Country_FM' => 'মাইক্রোনেশিয়া',
      'Country_FO' => 'ফ্যারও দ্বীপপুঞ্জ',
      'Country_FR' => 'ফ্রান্স',
      'Country_GA' => 'গ্যাবন',
      ...
      'Country_GM' => 'গাম্বিয়া',
      'Country_GN' => 'গিনি',
      'Country_GP' => 'গুয়াদেলৌপ',
      ...
      'Country_GY' => 'গিয়ানা',
      'Country_HK' => 'হংকং এসএআর চীনা',
      'Country_HM' => 'হার্ড দ্বীপ এবং ম্যাকডোনাল্ড দ্বীপপুঞ্জ',
      'Country_HN' => 'হণ্ডুরাস',
      'Country_HR' => 'ক্রোয়েশিয়া',
      'Country_HT' => 'হাইতি',
      'Country_HU' => 'হাঙ্গেরি',
      ...
      'Country_KI' => 'কিরিবাতি',
      'Country_KM' => 'কমোরোস',
      'Country_KN' => 'সেন্ট কিটস ও নেভিস',
      'Country_KP' => 'উত্তর কোরিয়া',
      ...
      'Country_LI' => 'লিচেনস্টেইন',
      'Country_LK' => 'শ্রীলঙ্কা',
      'Country_LR' => 'লাইবেরিয়া',
      'Country_LS' => 'লেসোথো',
      'Country_LT' => 'লিথুয়ানিয়া',
      'Country_LU' => 'লাক্সেমবার্গ',
      'Country_LV' => 'লাত্ভিয়া',
      'Country_LY' => 'লিবিয়া',
      'Country_MA' => 'মোরক্কো',
      'Country_MC' => 'মোনাকো',
      'Country_MD' => 'মোল্দাভিয়া',
      'Country_ME' => 'মন্টিনিগ্রো',
      ...
      'Country_MS' => 'মন্টসেরাট',
      'Country_MT' => 'মাল্টা',
      'Country_MU' => 'মরিশাস',
      'Country_MV' => 'মালদ্বীপ',
      'Country_MW' => 'মালাউই',
      'Country_MX' => 'মেক্সিকো',
      'Country_MY' => 'মালয়েশিয়া',
      'Country_MZ' => 'মোজাম্বিক',
      'Country_NA' => 'নামিবিয়া',
      'Country_NC' => 'নিউ ক্যালেডোনিয়া',
      'Country_NE' => 'নাইজার',
      'Country_NF' => 'নিরফোক দ্বীপ',
      'Country_NG' => 'নাইজেরিয়া',
      'Country_NI' => 'নিকারাগুয়া',
      'Country_NL' => 'নেদারল্যান্ডস',
      'Country_NO' => 'নরওয়ে',
      'Country_NP' => 'নেপাল',
      'Country_NR' => 'নাউরু',
      'Country_NU' => 'নিউয়ে',
      ...
      'Country_TG' => 'টোগো',
      'Country_TH' => 'থাইল্যান্ড',
      'Country_TJ' => 'তাজিকস্থান',
      'Country_TK' => 'টোকেলাউ',
      ...
      'Country_UY' => 'উরুগুয়ে',
      'Country_UZ' => 'উজবেকিস্তান',
      'Country_VA' => 'ভ্যাটিকান সিটি',
      ...
      'Country_WS' => 'সামোয়া',
      'Country_YE' => 'ইয়েমেন',
      'Country_YT' => 'মায়োত্তে',
      'Country_ZA' => 'দক্ষিণ আফ্রিকা',
      'Country_ZM' => 'জাম্বিয়া',
      'Country_ZW' => 'জিম্বাবোয়ে',
      'Day_Long_1' => 'সোমবার',
      'Day_Long_2' => 'মঙ্গলবার',
      'Day_Long_3' => 'বুধবার',
      ...
      'Day_Long_6' => 'শনিবার',
      'Day_Long_7' => 'রবিবার',
      'Day_Long_StandAlone_1' => 'সোমবার',
      'Day_Long_StandAlone_2' => 'মঙ্গলবার',
      'Day_Long_StandAlone_3' => 'বুধবার',
      'Day_Long_StandAlone_4' => 'বৃহষ্পতিবার',
      'Day_Long_StandAlone_5' => 'শুক্রবার',
      'Day_Long_StandAlone_6' => 'শনিবার',
      'Day_Long_StandAlone_7' => 'রবিবার',
      'Day_Min_1' => 'সোঃ',
      'Day_Min_2' => 'মঃ',
      'Day_Min_3' => 'বুঃ',
      'Day_Min_4' => 'বৃঃ',
      ...
      'Day_Min_6' => 'শোঃ',
      'Day_Min_7' => 'রঃ',
      'Day_Min_StandAlone_1' => 'সোঃ',
      'Day_Min_StandAlone_2' => 'মঃ',
      'Day_Min_StandAlone_3' => 'বুঃ',
      'Day_Min_StandAlone_4' => 'বৃঃ',
      'Day_Min_StandAlone_5' => 'শুঃ',
      'Day_Min_StandAlone_6' => 'শনি',
      'Day_Min_StandAlone_7' => 'রঃ',
      'Day_Short_1' => 'সোম',
      'Day_Short_2' => 'মঙ্গল',
      'Day_Short_3' => 'বুধ',
      'Day_Short_4' => 'বৃহস্পতি',
      'Day_Short_5' => 'শুক্র',
      'Day_Short_6' => 'শনি',
      'Day_Short_7' => 'রবি',
      'Day_Short_StandAlone_1' => 'সোম',
      'Day_Short_StandAlone_2' => 'মঙ্গল',
      'Day_Short_StandAlone_3' => 'বুধ',
      'Day_Short_StandAlone_4' => 'বৃহস্পতি',
      ...
      'LayoutDirection' => 'ltr',
      'Minutes' => 'মিনিট',
      'Month_Long_1' => 'জানুয়ারী',
      'Month_Long_10' => 'অক্টোবর',
      'Month_Long_11' => 'নভেম্বর',
      'Month_Long_12' => 'ডিসেম্বর',
      'Month_Long_2' => 'ফেব্রুয়ারী',
      'Month_Long_3' => 'মার্চ',
      'Month_Long_4' => 'এপ্রিল',
      'Month_Long_5' => 'মে',
      'Month_Long_6' => 'জুন',
      'Month_Long_7' => 'জুলাই',
      'Month_Long_8' => 'আগস্ট',
      'Month_Long_9' => 'সেপ্টেম্বর',
      'Month_Long_StandAlone_1' => 'জানুয়ারী',
      'Month_Long_StandAlone_10' => 'অক্টোবর',
      'Month_Long_StandAlone_11' => 'নভেম্বর',
      'Month_Long_StandAlone_12' => 'ডিসেম্বর',
      'Month_Long_StandAlone_2' => 'ফেব্রুয়ারী',
      'Month_Long_StandAlone_3' => 'মার্চ',
      'Month_Long_StandAlone_4' => 'এপ্রিল',
      'Month_Long_StandAlone_5' => 'মে',
      'Month_Long_StandAlone_6' => 'জুন',
